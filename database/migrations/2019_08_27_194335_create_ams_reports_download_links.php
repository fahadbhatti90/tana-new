...
class CreateAmsReportsDownloadLinks extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_report_link', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_report_link');
    }
}
