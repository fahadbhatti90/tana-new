...
class CreateTblAmsCampaignSpReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_campaign_sp_report_data', function (Blueprint $table) {
            ...
            $table->string('campaign_rule_based_budget',50);

            $table->string('applicable_budget_rule_id',50);
            $table->string('applicable_budget_rule_name',50);
            ...
            $table->string('attributed_units_ordered_1d_same_sku',50)->default(0);
            $table->string('attributed_units_ordered_7d_same_sku',50)->default(0);
            $table->string('attributed_units_ordered_14d_same_sku',50)->default(0);
            $table->string('attributed_units_ordered_30d_same_sku',50)->default(0);
    ...
    {
        Schema::dropIfExists('tbl_ams_campaign_sp_report_data');
    }
}
