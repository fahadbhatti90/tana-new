...
class CreateTblAmsKeywordSpReportIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_keyword_sp_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_keyword_sp_report_id');
    }
}
