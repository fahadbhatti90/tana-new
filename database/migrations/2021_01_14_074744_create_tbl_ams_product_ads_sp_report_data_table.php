...
class CreateTblAmsProductAdsSpReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_product_ads_sp_report_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_product_ads_sp_report_data');
    }
}
