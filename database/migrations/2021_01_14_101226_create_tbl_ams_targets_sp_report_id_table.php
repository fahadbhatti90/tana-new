...
class CreateTblAmsTargetsSpReportIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_targets_sp_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_targets_sp_report_id');
    }
}
