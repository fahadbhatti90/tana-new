...
class CreateTblAmsTargetsSpReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_targets_sp_report_data', function (Blueprint $table) {
            ...
            $table->string('targeting_expression', 255);
            $table->string('targeting_text', 255);
            $table->string('targeting_type', 255);
    ...
    {
        Schema::dropIfExists('tbl_ams_targets_sp_report_data');
    }
}
