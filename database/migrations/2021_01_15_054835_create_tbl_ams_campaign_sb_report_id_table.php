...
class CreateTblAmsCampaignSbReportIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_campaign_sb_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_campaign_sb_report_id');
    }
}
