...
class CreateTblAmsAdGroupSbReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_ad_group_sb_report_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_ad_group_sb_report_data');
    }
}
