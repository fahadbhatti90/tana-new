...
class CreateTblAmsCampaignSdReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_campaign_sd_report_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_campaign_sd_report_data');
    }
}
