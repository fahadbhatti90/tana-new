...
class CreateTblAmsAdGroupSdReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_ad_group_sd_report_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_ad_group_sd_report_data');
    }
}
