...
class CreateTblAmsProductAdsSdReportIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_product_ads_sd_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_product_ads_sd_report_id');
    }
}
