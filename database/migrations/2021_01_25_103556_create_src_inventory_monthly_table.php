...
class CreateSrcInventoryMonthlyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('src_inventory_monthly', function (Blueprint $table) {
            ...
            $table->string('net_received', 14)->nullable();
            $table->string('net_received_units', 10)->nullable();
            $table->string('sell_through_rate', 10)->nullable();
            $table->string('open_purchase_order_quantity', 12)->nullable();
            ...
            $table->string('unsellable_on_hand_units', 10)->nullable();
            ...
            $table->string('aged_90+_days_sellable_units', 10)->nullable();
    ...
    {
        Schema::dropIfExists('src_inventory_monthly');
    }
}
