...
class CreateStgAmsCampaignSummaryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stg_ams_campaign_summary', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('stg_ams_campaign_summary');
    }
}
