...
class CreateMetadataCoreAmsCampaignTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('metadata_core_ams_campaign', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('metadata_core_ams_campaign');
    }
}
