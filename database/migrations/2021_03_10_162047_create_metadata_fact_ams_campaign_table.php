...
class CreateMetadataFactAmsCampaignTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('metadata_fact_ams_campaign', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('metadata_fact_ams_campaign');
    }
}
