...
class AddRemoveColumnFactAmsCampaignWeeklySummary extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->table('fact_ams_campaign_weekly_summary', function ($table) {
            ...
            $table->unsignedDecimal('roas', 20, 4)->nullable(false)->change();
            $table->unsignedDecimal('acos', 20, 4)->nullable(false)->change();
    ...
    public function down()
    {
        Schema::connection('mysql2')->table('fact_ams_campaign_weekly_summary', function ($table) {
            ...
            $table->unsignedDecimal('roas', 20, 4)->nullable()->change();
            $table->unsignedDecimal('acos', 20, 4)->nullable()->change();
