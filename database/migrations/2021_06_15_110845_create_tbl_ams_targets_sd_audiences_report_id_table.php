...
class CreateTblAmsTargetsSdAudiencesReportIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_targets_sd_audiences_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_targets_sd_audiences_report_id');
    }
}
