...
class CreateLogAmsCampaignSbReportIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_ams_campaign_sb_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('log_ams_campaign_sb_report_id');
    }
}
