...
class CreateLogAmsCampaignSpReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_ams_campaign_sp_report_data', function (Blueprint $table) {
            ...
            $table->string('campaign_rule_based_budget',150);

            $table->string('applicable_budget_rule_id',150);
            $table->string('applicable_budget_rule_name',150);
            ...
            $table->string('attributed_units_ordered_1d_same_sku',150);
            $table->string('attributed_units_ordered_7d_same_sku',150);
            $table->string('attributed_units_ordered_14d_same_sku',150);
            $table->string('attributed_units_ordered_30d_same_sku',150);
    ...
    {
        Schema::dropIfExists('log_ams_campaign_sp_report_data');
    }
}
