...
class CreateLogAmsKeywordSpReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_ams_keyword_sp_report_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('log_ams_keyword_sp_report_data');
    }
}
