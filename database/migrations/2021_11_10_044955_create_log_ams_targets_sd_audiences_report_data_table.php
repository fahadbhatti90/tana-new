...
class CreateLogAmsTargetsSdAudiencesReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_ams_targets_sd_audiences_report_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('log_ams_targets_sd_audiences_report_data');
    }
}
