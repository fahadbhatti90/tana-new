...
class CreateLogAmsTargetsSdReportIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_ams_targets_sd_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('log_ams_targets_sd_report_id');
    }
}
