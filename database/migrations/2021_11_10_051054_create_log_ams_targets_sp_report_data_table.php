...
class CreateLogAmsTargetsSpReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_ams_targets_sp_report_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('log_ams_targets_sp_report_data');
    }
}
