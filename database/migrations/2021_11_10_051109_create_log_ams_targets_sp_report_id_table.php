...
class CreateLogAmsTargetsSpReportIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_ams_targets_sp_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('log_ams_targets_sp_report_id');
    }
}
