...
class CreateMetadataLogAmsTargetsAudiencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('metadata_log_ams_targets_audiences', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('metadata_log_ams_targets_audiences');
    }
}
