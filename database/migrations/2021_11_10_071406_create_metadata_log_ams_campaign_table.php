...
class CreateMetadataLogAmsCampaignTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('metadata_log_ams_campaign', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('metadata_log_ams_campaign');
    }
}
