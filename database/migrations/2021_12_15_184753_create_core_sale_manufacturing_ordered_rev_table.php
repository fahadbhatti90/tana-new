...
class CreateCoreSaleManufacturingOrderedRevTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('core_sale_manufacturing_ordered_rev', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('core_sale_manufacturing_ordered_rev');
    }
}
