...
class CreateMetadataFactSaleManufacturingOrderedRevTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('metadata_fact_sale_manufacturing_ordered_rev', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('metadata_fact_sale_manufacturing_ordered_rev');
    }
}
