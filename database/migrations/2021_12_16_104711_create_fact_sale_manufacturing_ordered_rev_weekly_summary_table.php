...
class CreateFactSaleManufacturingOrderedRevWeeklySummaryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
            Schema::connection('mysql2')->create('fact_sale_manufacturing_ordered_rev_weekly_summary', function (Blueprint $table){
    ...
    {
        Schema::connection('mysql2')->dropIfExists('fact_sale_manufacturing_ordered_rev_weekly_summary');
    }
}
