...
class CreateLogAmsKeywordSearchTermSpReportIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_ams_keyword_search_term_sp_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('log_ams_keyword_search_term_sp_report_id');
    }
}
