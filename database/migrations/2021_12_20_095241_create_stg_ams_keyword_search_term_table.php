...
class CreateStgAmsKeywordSearchTermTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stg_ams_keyword_search_term', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('stg_ams_keyword_search_term');
    }
}
