...
class CreateFactAmsKeywordSearchTermMonthlyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('fact_ams_keyword_search_term_monthly', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql2')->dropIfExists('fact_ams_keyword_search_term_monthly');
    }
}
