...
class CreateMetadataLogAmsKeywordSearchTermTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('metadata_log_ams_keyword_search_term', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('metadata_log_ams_keyword_search_term');
    }
}
