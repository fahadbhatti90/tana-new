...
class CreateLogAmsProductAdsSdReportIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_ams_product_ads_sd_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('log_ams_product_ads_sd_report_id');
    }
}
