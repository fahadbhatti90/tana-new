...
class CreateLogAmsProductAdsSpReportDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_ams_product_ads_sp_report_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('log_ams_product_ads_sp_report_data');
    }
}
