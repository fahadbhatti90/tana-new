...
class CreateMetadataFactAmsProductAdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('metadata_fact_ams_product_ads', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('metadata_fact_ams_product_ads');
    }
}
