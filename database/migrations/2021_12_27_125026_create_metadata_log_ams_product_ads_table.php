...
class CreateMetadataLogAmsProductAdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('metadata_log_ams_product_ads', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('metadata_log_ams_product_ads');
    }
}
