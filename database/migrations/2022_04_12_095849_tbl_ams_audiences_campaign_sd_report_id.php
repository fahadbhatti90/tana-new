...
class TblAmsAudiencesCampaignSdReportId extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_campaign_sd_audiences_report_id', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_campaign_sd_audiences_report_id');
    }
}
