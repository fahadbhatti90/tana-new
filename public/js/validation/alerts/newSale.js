                    ...
                    for (var count = 0; count < response.kpi.length; count++) {
                        switch (response.kpi[count].kpi_name) {
                            ...
                            case 'shipped_unit':
                                ...
                                break;
                            case 'net_received':
                                $('#kpi_id').append('<option value="' + response.kpi[count].kpi_id + '">Net Receipts</option>');
                                $('#template-kpi-id').append('<option value="' + response.kpi[count].kpi_id + '">Net Receipts</option>');
                                break;
                            case 'confirmation_rate':
                                $('#kpi_id').append('<option value="' + response.kpi[count].kpi_id + '">Confirmation Rate</option>');
                                $('#template-kpi-id').append('<option value="' + response.kpi[count].kpi_id + '">Confirmation Rate</option>');
                                break;
                            case 'yoy':
                                $('#kpi_id').append('<option value="' + response.kpi[count].kpi_id + '">YOY</option>');
                                $('#template-kpi-id').append('<option value="' + response.kpi[count].kpi_id + '">YOY</option>');
                                break;
                            default:
                        ...
                        for (var count = 0; count < response.threshold.length; count++) {
                            ...
                            switch (response.threshold[count].kpi_name) {
                                ...
                                case 'shipped_unit':
                                    ...
                                    break;
                                case 'net_received':
                                    html += "<td style='white-space: nowrap;'>Net Receipts</td>";
                                    break;
                                case 'confirmation_rate':
                                    html += "<td style='white-space: nowrap;'>Confirmation Rate</td>";
                                    break;
                                case 'yoy':
                                    html += "<td style='white-space: nowrap;'>YOY</td>";
                                    break;
                                default:
