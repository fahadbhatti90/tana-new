                ...
                region: {
                    validators: {
                        ...
                        stringLength: {
                            min: 1,
                            max: 4,
                            message: 'The vendor region must be less than 5 characters long'
                        },
                        regexp: {
                            regexp: /^[A-Z]+$/,
                            message: 'The vendor region can only consist of uppercase alphabet'
                        },
                    }
                },
                tier: {
            ...
            success: function (data) {
                ...
                if (data.result && data.result.length > 0) {
                    ...
                    for (var count = 0; count < data.result.length; count++) {
                        html += '<option value=' + data.result[count].vendor_id + '>' + data.result[count].vendor_name + " - " + data.result[count].region + '</option>';
                    }
