            ...
            <div class="form-group breadcrum-right">
                <div class="dropdown">
                    <button name="create_record" id="create_record" class="btn-icon btn btn-info waves-effect waves-light" type="button">
                        <i class="feather icon-plus"></i> Add New Admin
                    </button>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">List of all  admins</h4>
                        </div>
...
@section('formValidation')
    <script src="{{ asset('js/validation/admin.js') }}"></script>
@endsection
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="admin_modal_title"></h4>
