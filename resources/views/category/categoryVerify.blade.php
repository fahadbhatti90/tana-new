...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Verify Category</h2>
    ...
    @if(checkOptionPermission(array(9),3))
    <div class="content-header-right text-md-right col-md-3 col-12 d-md-block">
        <div class="form-group breadcrum-right">
            <div class="dropdown">
                <a name="create_record" id="moveData" href="{{route('verifyCategory.categoryMoveData')}}" class=" btn-icon btn btn-info btn-round" type="button" style="color:white">
                        ...
                        <div class="card-body card-dashboard">
                            <div class="card-body">
                                <div class="users-list-filter">
                                    @if(checkOptionPermission(array(9),4))
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 col-12">
                                                ...
                                                <fieldset class="form-group">
                                                    <select class="form-control" id="category_filter_vendor" name="category_filter_vendor" required>
                                    ...
                                    <div class="table-responsive">
                                        <table id="category_table" class="table" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Row Id</th>
                                                    <th>Vendor Name</th>
...
<script src="{{ asset('js/validation/categoryVerify.js') }}"></script>
@endsection
