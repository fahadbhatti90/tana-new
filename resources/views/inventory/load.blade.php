                                                                ...
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-8 offset-md-3">
                                                                            <button type="submit" name="load_daily_inventory" id="load_daily_inventory" class="btn btn-info mr-1 mb-1 waves-effect waves-light">Load Daily Inventory</button>
                                                                            <button hidden id="load_daily_inventory_loader" class="btn btn-info mb-1 waves-effect waves-light" type="button">
                                                            ...
                                                            <form class="form form-horizontal" id="load_weekly_inventory_form">
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-8 offset-md-3">
                                                                            <button type="submit" name="load_weekly_inventory" id="load_weekly_inventory" class="btn btn-info mr-1 mb-1 waves-effect waves-light">Load Weekly Inventory</button>
                                                                            <button hidden id="load_weekly_inventory_loader" class="btn btn-info mb-1 waves-effect waves-light" type="button">
                                                                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                                                                Loading ...
                                                                            </button>
                                                                        </div>
                                                            ...
                                                            <form class="form form-horizontal" id="load_monthly_inventory_form">
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-8 offset-md-3">
                                                                            <button type="submit" name="load_monthly_inventory" id="load_monthly_inventory" class="btn btn-info mr-1 mb-1 waves-effect waves-light">Load Monthly Inventory</button>
                                                                            <button hidden id="load_monthly_inventory_loader" class="btn btn-info mb-1 waves-effect waves-light" type="button">
                                                                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                                                                Loading ...
                                                                            </button>
                                                                        </div>
