    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Super Admin Information</h2>
        ...
        @if(checkOptionPermission(array(1),2))
            ...
            <div class="form-group breadcrum-right">
                <div class="dropdown">
                    <button name="create_record" id="create_record" class="btn-icon btn btn-info waves-effect waves-light" type="button">
                        <i class="feather icon-plus"></i> Add New Super Admin
                    </button>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">List of all super admins</h4>
                        </div>
...
@section('formValidation')
    <script src="{{ asset('js/validation/superadmin.js') }}"></script>
@endsection
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="super_modal_title"></h4>
                ...
                <form method="post" id="user_form">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" name="action_button" id="action_button" class="btn btn-info" value="Add Super Admin" />
