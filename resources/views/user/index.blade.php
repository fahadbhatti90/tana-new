    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">User Information</h2>
        ...
        @if(checkOptionPermission(array(3),2))
...
@section('formValidation')
    <script src="{{ asset('js/validation/user.js') }}"></script>
@endsection
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4  id="user_model_title" class="modal-title"></h4>
