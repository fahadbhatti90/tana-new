...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Verify Sales</h2>
    ...
    <div class="content-header-right text-md-right col-md-3 col-12 d-md-block">
        <div class="form-group breadcrum-right">
            <div class="dropdown">
                ...
                <a name="create_record" id="move" href="{{route('verify.saleToCore')}}" class=" btn-icon btn btn-info btn-round" type="button" style="color:white">
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            <div class="table-responsive">
                                <table id="users_table1" class="table" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Vendor Name</th>
                                            <th>No. of day(s)</th>
...
<script src="{{ asset('js/validation/verify.js') }}"></script>
@endsection
